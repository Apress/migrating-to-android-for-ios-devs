...
public class HelloService extends IntentService {
  ...
  protected void onHandleIntent(Intent intent) {
    Log.i("HelloService", "onHandleIntent");
...
//    sendGlobalBroadcast(fname, lname);
  ...
  private void sendGlobalBroadcast(String fname, String lname) {
    ...
    broadcastIntent.setAction("com.pdachoice.appcomponents.Hello");
    ...
    // specify permission
//    String permission = "com.pdachoice.appcomponents.HELLO_PERMISSION";
